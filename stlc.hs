...
--  1. Fill in any unknown types with type variables
--  2. Generate constraints from type variables based on typing rules
--  3. Solve the constraints to resolve the type variables
